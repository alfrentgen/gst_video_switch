...
int main(int argc, char* argv[])
{
    ...
    gst_bin_add_many(GST_BIN(pipeline), src1, src2, segment, video_switch, video_sink, sink1_sync, sink2_sync, capsfilter, NULL);
    ...
    g_timeout_add(5000, (GSourceFunc)switch_timer, video_switch);
